...
@section('title', "Editar Responsable: {$responsable->nombre}")
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="nombre" id="nombre"
                           ...
                           value="{{ old('nombre', $responsable->nombre) }}" required maxlength="255">
                </div>
                <div class="col-md-6">
                    <label for="cargo" class="form-label">Cargo</label>
                    <input type="text" name="cargo" id="cargo"
                           class="form-control @error('cargo') is-invalid @enderror"
                           value="{{ old('cargo', $responsable->cargo) }}" maxlength="255">
                </div>
                <div class="col-md-6">
                    <label for="email" class="form-label">Email</label>
                    <input type="email" name="email" id="email"
                           class="form-control @error('email') is-invalid @enderror"
                           value="{{ old('email', $responsable->email) }}" maxlength="255">
                </div>
                <div class="col-md-6">
                    <label for="telefono" class="form-label">Teléfono</label>
                    <input type="text" name="telefono" id="telefono"
                           class="form-control @error('telefono') is-invalid @enderror"
                           value="{{ old('telefono', $responsable->telefono) }}" maxlength="50">
                </div>
            </div>
